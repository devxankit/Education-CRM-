    ...
    return (
        <div ref={cardRef} className="bg-white rounded-2xl p-5 border border-purple-100 shadow-sm relative overflow-hidden group">
            ...
            <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                    <h3 className="text-base font-bold text-gray-900 leading-tight pr-12">{exam.title}</h3>
                    <p className="text-sm font-medium text-purple-600 mt-1">{exam.subjects.join(", ")}</p>
                </div>
            </div>
