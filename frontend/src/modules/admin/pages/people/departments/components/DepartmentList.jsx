                ...
                {departments.map((dept) => (
                    ...
                    >
                        <div className="flex justify-between items-start mb-2">
                            <div>
                                <h4 className={`font-bold text-sm ${selectedId === dept.id ? 'text-indigo-900' : 'text-gray-800'}`}>
                                    {dept.name}
                                </h4>
                        ...
                        <div className={`absolute right-3 top-1/2 -translate-y-1/2 text-gray-300 ${selectedId === dept.id ? 'text-indigo-400' : 'opacity-0 group-hover:opacity-100'}`}>
