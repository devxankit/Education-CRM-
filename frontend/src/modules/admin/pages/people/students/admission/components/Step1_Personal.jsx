    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    <label className="block text-xs font-bold text-gray-500 uppercase mb-1">Parent / Guardian Name <span className="text-red-500">*</span></label>
                    <input
                        type="text"
                ...
                <div>
                    <label className="block text-xs font-bold text-gray-500 uppercase mb-1">Parent Mobile <span className="text-red-500">*</span></label>
                    <input
                        type="tel"
