...
const StudentTable = () => {
    ...
    // Mock Data
    const students = [
        { id: 1, admNo: 'A-2024-001', name: 'Aarav Sharma', class: '10', section: 'A', roll: 12, parent: 'Rajiv Sharma', contact: '9876543210', status: 'Active' },
        { id: 2, admNo: 'A-2024-005', name: 'Ishita Patel', class: '10', section: 'A', roll: 13, parent: 'Nilesh Patel', contact: '9876543211', status: 'Active' },
        { id: 3, admNo: 'A-2024-012', name: 'Rohan Mehta', class: '9', section: 'B', roll: "08", parent: 'Sanjay Mehta', contact: '9876543212', status: 'Fees Due' },
        { id: 4, admNo: 'A-2024-045', name: 'Ananya Gupta', class: '9', section: 'B', roll: "09", parent: 'Vikram Gupta', contact: '9876543213', status: 'Active' },
        { id: 5, admNo: 'A-2024-102', name: 'Kabir Singh', class: '8', section: 'C', roll: 21, parent: 'Preeti Singh', contact: '9876543214', status: 'Inactive' },
    ];
    ...
    return (
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div className="p-4 border-t border-gray-100 flex items-center justify-between text-xs text-gray-500">
                <span>Showing 1 to 5 of 2845 entries</span>
