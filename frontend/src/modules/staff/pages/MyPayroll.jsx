...
const MyPayroll = () => {
    ...
    const fetchPayrolls = async () => {
        ...
        try {
            ...
            const response = await fetch(
                `${API_URL}/payroll?employeeType=staff&employeeId=${user._id}&year=${selectedYear}&month=${selectedMonth}`,
                {
    ...
    const generateInvoiceHTML = (payroll) => {
        ...
        return `
            ...
            <html>
            <head>
                <title>Salary Payslip - ${user?.name || ''}</title>
                <style>
                    @media print {
                ...
                <div class="payslip-container">
                    ...
                    <div class="payslip-info">
                        <div class="info-section">
                            ...
                            <p><strong>Employee ID:</strong> ${user?._id || 'N/A'}</p>
                            <p><strong>Designation:</strong> Staff</p>
                        </div>
                        <div class="info-section">
