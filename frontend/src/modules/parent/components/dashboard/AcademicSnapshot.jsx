        ...
        <div className="px-4 mb-8">
            ...
            <div className="grid grid-cols-3 gap-3">
                ...
                >
                    ...
                    <span className="text-lg font-extrabold text-gray-900">{data.attendance}%</span>
                ...
                >
                    ...
                    <span className="text-lg font-extrabold text-gray-900">{data.lastResult.marks}</span>
                    <span className="text-[10px] font-bold text-gray-400 uppercase">{data.lastResult.subject}</span>
                </div>
            </div>
        </div>
    );
